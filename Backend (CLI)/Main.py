...
def displayIssues(FO=0, Style=0):
    ...
    print(" ______________________________________________________________________________________________________________________\n|ID____|title____________________________|Status______________________________|Priority________________________________|\n|      |                                 |                                    |                                        |")#40_ 
    for ISS in data:
        ID = ISS[0]
        NAME = ISS[1]
        STA = ISS[3]
